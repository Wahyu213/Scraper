...
def update_tool():
	...
	if source.text == '3':
		...
		os.system("""
			curl -s -O https://raw.githubusercontent.com/Wahyu213/Scraper/master/add2group.py
			curl -s -O https://raw.githubusercontent.com/Wahyu213/Scraper/master/scraper.py
			curl -s -O https://raw.githubusercontent.com/Wahyu213/Scraper/master/setup.py
			curl -s -O https://raw.githubusercontent.com/Wahyu213/Scraper/master/smsbot.py
			chmod 777 *.py
			""");time.sleep(3)
...
try:
	...
	print(gr+'['+re+'!'+gr+']'+cy+' for help use : ')
	print(gr+'['+re+'!'+gr+']'+cy+' https://github.com/Wahyu213/Scraper#-how-to-install-and-use')
	print(gr+'$ python3 setup.py -h'+'\n')
